<script lang="ts">
	...
	import { Monitor, Smartphone, Tv, Download, Info, Terminal, Cpu, Activity, ShieldCheck, Zap } from 'lucide-svelte';
	...
	function getLatest(platform: string) {
		return releases.find((r) => r.platform === platform) || { version: 'N/A', size: 'N/A', download_url: '#' };
	}
</script>
			...
			>
				...
				>
					...
					<div class="card-content">
						...
						<h2 class="card-title">TV OS</h2>
						<p class="card-description">
							Android TV optimized streaming client with leanback UI and remote control support.
						</p>
...
.indicator-dot.accent { background: #ff9800; box-shadow: 0 0 8px #ff9800; }

.indicator-label.accent { color: #ff9800; }
