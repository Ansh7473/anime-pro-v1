<script lang="ts">
  ...
  import { Shield, Mail, Lock, User, Terminal, Cpu } from "lucide-svelte";
  ...
  async function handleLogin(e: Event) {
    ...
    try {
      ...
      error = e.message || "AUTHENTICATION_FAILED: ACCESS_DENIED";
    } finally {
      loading = false;
    }
  }
  ...
  <main class="auth-container">
    <div class="auth-card glass">
      ...
      <header class="card-header">
        <div class="header-status">
          ...
          <span class="status-text">SYSTEM_ACTIVE // SECURE_LINK</span>
        </div>
        <div class="title-group">
          <h1>WELCOME BACK</h1>
          <div class="subtitle">
            <Terminal size={14} />
            <span>OPERATOR_AUTHENTICATION_REQUIRED</span>
          </div>
        </div>
      </header>
      ...
      {#if error}
        <div class="error-box glass">
          ...
          <div class="error-content">
            <span class="error-title">SECURITY_ALERT</span>
      ...
      <form onsubmit={handleLogin} class="auth-form">
        <div class="form-group">
          <label for="email">
            <span class="label-text">OPERATOR_ID</span>
            <span class="label-desc">Primary Communication Link</span>
          </label>
        ...
        <div class="form-group">
          <label for="password">
            ...
            <span class="label-desc">Encrypted Permission Set</span>
          </label>
          <div class="input-wrapper">
        ...
        <button type="submit" class="submit-btn" disabled={loading}>
          <div class="btn-content">
            ...
            <span>
              {loading ? "INITIALIZING_SESSION..." : "ESTABLISH_CONNECTION"}
            </span>
          </div>
      ...
      <footer class="card-footer">
        ...
        <div class="footer-links">
          <span class="footer-text">NEW_OPERATOR?</span>
          <a href="/auth/register" class="accent-link">REGISTER_ACCOUNT</a>
        </div>
      </footer>
    </div>
    ...
    <div class="tactical-meta hide-mobile">
      <div class="meta-item">
        ...
        <span class="value">BOM_HUB_01</span>
      </div>
      <div class="meta-item">
        <span class="label">ENC:</span>
        <span class="value">AES-256-V2</span>
      </div>
    </div>
  </main>
</div>
...
<style>
  ...
  .glow-point {
    ...
    width: 600px;
    height: 400px;
    background: radial-gradient(ellipse, var(--auth-accent-dim), transparent 70%);
    filter: blur(80px);
    opacity: 0.3;
  }
  ...
  .label-desc { font-size: 0.65rem; color: var(--auth-text-dim); }
